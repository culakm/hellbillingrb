...
if (isDevelopment) {
	console.log(
		'Firebase App Check debug mode enabled. PROJECT ID IS : ' +
			import.meta.env.VITE_FIREBASE_PROJECT_ID
	);
	if (import.meta.env.VITE_FIREBASE_PROJECT_ID !== 'hellbilling') {
		console.log(
			'Using foreign "hellbilling" debug token : ' +
				import.meta.env.VITE_FIREBASE_APPCHECK_DEBUG_TOKEN_HB
		);
		self.FIREBASE_APPCHECK_DEBUG_TOKEN =
			import.meta.env.VITE_FIREBASE_APPCHECK_DEBUG_TOKEN_HB;
	} else {
		console.log(
			'Using my own hellbilling debug token : ' +
