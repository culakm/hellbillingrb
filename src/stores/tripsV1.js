...
export const useTripsStore = defineStore('trips', () => {
	...
	async function loadLines2(tripId) {
		...
		await linesStore.setTripId(tripId);  // wait for lines loaded

		console.log("Finished loading lines for tripId:", tripId);
		...
		console.log("Trip lines loaded into trips:", trips.value);
	}
	...
	// 	trip.lines = linesStore.lines.value;  // assign the ref's value
