...
- **pdfMake** (`^0.3.7`) — declarative PDF generation library (used in `src/composables/usePdfExport.js`)
- **html-to-pdfmake** (`^2.5.33`) — converts HTML strings to pdfMake document definition format
